...
function VideoPlayer({
  ...
  return (
    ...
    >
      ...
      {showControls && (
        <div
          className={`absolute bottom-0 left-0 right-0 bg-gray-800 bg-opacity-75 py-8 md:py-4 px-4 transition-opacity duration-300 ${
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <Button
                ...
                className="text-white bg-transparent hover:text-white hover:bg-gray-700 size-4 md:size-6"
              >
                {playing ? (
            ...
            <div className="flex items-center space-x-2">
              <div className="text-white text-[12px] md:text-base">
